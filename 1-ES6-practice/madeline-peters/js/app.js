...
function displayPics(){
  ...
  //let, unlike var, declares variables with block, expression, or statement level scope. Var can be used to define //variables globally or also locally to a whole function. Thus, since the console log is outside of the block, //when var is changed to let, the console log which is in another block of the fn cannot see down to the block //level-scope that the variable is defined on.
  console.log(viewed);
